...
class Kazagumo extends events_1.EventEmitter {
    ...
    search(query, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.buildSearch((_b = normalizedData.playlistName) !== null && _b !== void 0 ? _b : undefined, normalizedData.tracks.map((track) => new KazagumoTrack_1.KazagumoTrack(track, options === null || options === void 0 ? void 0 : options.requester)), loadType);
        });
    }
